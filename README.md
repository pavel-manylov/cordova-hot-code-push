...
**Is it fine with App Store?** Yes, it is... as long as your content corresponds to what application is intended for and you don't ask user to click some button to update the web content. For more details please refer to [this wiki page](https://github.com/Saritasa/cordova-hot-code-push/wiki/App-Store-FAQ).
...
```sh
cordova plugin add https://github.com/Saritasa/cordova-hot-code-push.git
```

At the end of the installation plugin will recommend you to install [Cordova Hot Code Push CLI client](https://github.com/Saritasa/cordova-hot-code-push-cli). This client will help you to:
...
In this guide we will show how quickly you can test this plugin and start using it for development. For that we will install [development add-on](https://github.com/Saritasa/cordova-hot-code-push/wiki/Local-Development-Plugin).
...
For production build do not forget to add the following to your `config.xml` file as it is a required property. Checkout the [wiki](https://github.com/Saritasa/cordova-hot-code-push/wiki/Cordova-config-preferences) for more information:
...
All documentation can be found in details in our [Wiki on GitHub](https://github.com/Saritasa/cordova-hot-code-push/wiki).

If you have some questions/problems/suggestions - don't hesitate to post a [thread](https://github.com/Saritasa/cordova-hot-code-push/issues). If it's an actual issue - please, follow [this guide](https://github.com/Saritasa/cordova-hot-code-push/wiki/Issue-creation-guide) on how to do that properly.
